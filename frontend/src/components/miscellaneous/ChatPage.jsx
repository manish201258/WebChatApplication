  ...
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content profile-model-content">
      <div className="modal-body profile-model-body"> 
        <div className='profile-photo'style={{backgroundImage:"URL('https://static.vecteezy.com/system/resources/previews/030/694/430/non_2x/top-2d-cartoon-vector-illustration-on-white-background-hig-free-photo.jpg')", backgroundSize:"contain", backgroundRepeat:"no-repeat"}}></div>
        <div className='m-3'>
