...
const ChatWindow = () => {
  const { chatPerson, isAuthenticated, clicked, deleteConversation,blockConversation,unblockConversation,blockedUsers,allBlockedData,setClicked,clicked} = UseAuth();
  ...
  return (
      <div className="chatwindow" style={{background:clicked!=null?("transparent"):("#c4b9b97c"),
      }}>
