...
const ChatBox = () => {
  ...
  const createdAt = new Date(data.createdAt); // Create a Date object from createdAt string
const time = createdAt.toLocaleTimeString(); // Extract the time in a readable format
