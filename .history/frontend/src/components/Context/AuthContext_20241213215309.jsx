...
const allBlockedData = async() => {
  ...
  return (
    <AuthContext.Provider value={{ authenticate , isAuthenticated, currentUser,logout,sideUser,sideClicked,userSideData,clicked,chatPerson,deleteConversation,blockConversation,unblockConversation,allBlockedData,blockedUsers,setClicked,loading}}>
      {children}
